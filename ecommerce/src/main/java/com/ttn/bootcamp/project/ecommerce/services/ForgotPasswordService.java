        ...
        try {
            if (null != user) {
                if (user.isActive()) {
                    ...
                    sendEmail.sendEmail("Reset your password", "To reset your password, please click here : http://localhost:8080/ecommerce/forgotPassword/reset-password?token=" + token + "&email=" + email, email);
